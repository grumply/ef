...
getScope :: Knows Knot self super => Narrative self super a -> super Int
...
linearize :: Knows Knot self super
...
cat :: (Subtype '[Knot] self, Monad super) => Line a a self super r
