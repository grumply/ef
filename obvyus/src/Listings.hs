...
data Listings (pg :: x) k
    = Listings
          { listingsArray
              :: forall self super.
                 (Array Int (Object '[Listing] (Narrative self super)),k)
          }
    | forall self super. ListingsArray
        (Array Int (Object '[Listing] (Narrative self super)) -> k)

listings :: (Monad super, '[Listings pg] .> traits)
         => Trait (Listings pg) traits super
listings = Listings (unsafeCoerce $ array (1,20) [],return)

provocativeListingsArray
  :: forall self super. (Monad super, '[Listings 'ProvocativeListings] :> self)
  => Narrative self super (Array Int (Object '[Listing] (Narrative self super)))
provocativeListingsArray =
  self (ListingsArray id
          :: Listings
               ProvocativeListings
               (Array Int (Object '[Listing] (Narrative self super)))
       )

interestingListingsArray
  :: forall self super. (Monad super, '[Listings 'InterestingListings] :> self)
  => Narrative self super (Array Int (Object '[Listing] (Narrative self super)))
interestingListingsArray =
  self (ListingsArray id
          :: Listings
